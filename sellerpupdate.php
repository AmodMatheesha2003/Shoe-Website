...
/*  */
  ...
  <body>
    <div class="main-container">
      ...
      <div class="left-container">
        ...
        <h1>PRODUCT</h1>
            ...
            <a href="sellerpupdate.php" class="button active">Product Update</a>
            <a href="sellerpsearch.php" class="button">Product View</a>
            <a href="sellerpdelete.php" class="button del">Product Delete</a>
    ...
    <form action="sellerpupdate.php" method="post" enctype="multipart/form-data" name="updateProductForm">
