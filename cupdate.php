    ...
    if(isset($_POST["submit"])){
        ...
        if(!empty($_FILES["image"]["name"])){
            ...
            if(in_array($fileType, $allowTypes)){
                ...
                $sql = "UPDATE coustomerdetail SET Firstname='$firstname', lastname='$lastname', username='$username', password='$password', phonenumber='$phonenumber', address='$address', image='$imgContent'WHERE id='$cid'";
                $result = mysqli_query($con, $sql);

                if($result){
                    echo "Costomer information updated successfully";
                }
                else{
                    echo "Costomer information update failed, please try again!";
                }
            }
            else{
    ...
    <div class="main-container">
      ...
      <div class="left-container">
        ...
        <div class="container">
            ...
            <a href="cupdate.php" class="button active">Coustomer Update</a>
      ...
      <h1>Coustomer Update</h1>
    <form id="workerForm" action="cupdate.php" method="post" enctype="multipart/form-data">
        <label for="eid">Coustomer ID:</label>
