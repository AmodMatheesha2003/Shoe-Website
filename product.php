      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <div class="cart-user">
            <div class="nav-item">
                <a class="nav-link" href="Homepage.html"><img src="Image/home.png" width="30" height="30"></a>
              </div>
              <div class="nav-item">
                <a class="nav-link" href=""><img src="Image/cart1.png" width="30" height="30"></a>
              </div>
            </div>   
                ...
                <div class="col-md-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="product_details.php?id=<?php echo $id ?>" class="btn btn-primary">View Details</a>
