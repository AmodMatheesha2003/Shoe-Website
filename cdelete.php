<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $check_query = "SELECT * FROM coustomerdetail WHERE id = '$id'";
        $check_result = mysqli_query($con, $check_query);

        if(mysqli_num_rows($check_result) > 0) {
            
            $delete_query = "DELETE FROM coustomerdetail WHERE id = '$id'";
    ...
    <div class="main-container">
      ...
      <div class="left-container">
        ...
        <div class="container">
            ...
            <a href="cdelete.php" class="button active">Coustomer Delete</a>
            <a href="viewcontactus.php" class="button">Coustomer Review</a>
        </div>
      </div>

      <div class="right-container">
      <h1>DELETE COUSTOMER</h1>
    <form action="cdelete.php" method="post" enctype="multipart/form-data" name="deleteEmployeeForm">
        <label for="id">Enter coustomer ID to Delete:</label>
